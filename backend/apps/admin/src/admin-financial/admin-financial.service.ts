...
export class AdminFinancialService {
  ...
  async getDashboardSummary() {
    ...
    return {
      platform: { activePlatformFee: activeFee ? { id: activeFee.id, percentage: Number(activeFee.percentage), currency: activeFee.currency, label: activeFee.label ?? null, isActive: activeFee.isActive } : null, pendingPaymentsRequiringAction: pendingPaymentsCount, totalPaymentAccounts, activePaymentAccounts },
  ...
  async getOverview() {
    ...
    return {
      ...
      activeFee: activeFee ? { id: activeFee.id, percentage: Number(activeFee.percentage), currency: activeFee.currency, label: activeFee.label ?? null, isActive: activeFee.isActive, createdAt: activeFee.createdAt } : null,
      monthlyBreakdown,
